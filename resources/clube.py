...
class Clube(Resource):
    ...
    args.add_argument('name', type=str, required=True, help="Field 'Name' is required.")
    args.add_argument('city', type=str, required=True, help="Field 'City' is required.")
    args.add_argument('state', type=str, required=True, help="Field 'State' is required.")
    args.add_argument('logo', type=str, required=True, help="Field 'Logo' is required.")
    ...
    def put(self, clube_id):
        ...
        try:
            ...
            return {'message': 'An internal error ocurred trying to save clube'}, 500 # Internal server error
...
class ClubeAdd(Resource):
    ...
    def post(self):        
        dados = Clube.args.parse_args()
        clube = ClubeModel(None, dados.name, dados.city, dados.state, dados.logo)
        try:
            clube.save_clube()
        except:
            return {'message': 'An internal error occurred while saving'}, 500 # internal error
        return clube.json()
